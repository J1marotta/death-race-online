...
describe('WHY.html interactive page', () => {
  ...
  it('documents the authoritative server migration and juice constraints', () => {
    ...
    expect(juice.textContent).toContain('Start anticipation · complete')
    expect(juice.textContent).toContain('planned juice backlog is complete')
    ...
    expect(diary.textContent).toContain('Juice Is A State Projection')
